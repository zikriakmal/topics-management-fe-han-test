        ...
        <div className="flex sm:flex-row sm:items-start flex-col items-center gap-2">
            ...
            <div className="flex flex-col items-center flex-1">
                ...
                <div className="flex flex-row mt-2 gap-4">
                    <button onClick={() => likeAction({ id: 1, isLike: true })} className="hover:bg-red-900 hover:-translate-y-0.5 cursor-pointer flex-row text-xs text-white bg-red-600 flex gap-4 rounded border border-red-600 overflow-hidden">
                    ...
                    <button onClick={() => likeAction({ id: 1, isLike: false })} className="hover:bg-blue-200 hover:-translate-y-0.5 transition-all cursor-pointer flex-row text-xs text-blue-400 flex gap-4 rounded border border-blue-400 overflow-hidden">
                        <div className="flex flex-row p-2 py-1 items-center justify-center gap-2 flex-1">
